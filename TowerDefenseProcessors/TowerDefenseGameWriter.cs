...
{
    public abstract class TowerDefenseGameWriter<T> : ContentTypeWriter<T>
    {
        public override string GetRuntimeReader(TargetPlatform targetPlatform)
        {
            ...
            //    TowerDefenseGameDataWindows.  However, this means that type.FullName
            //    will specify TowerDefenseGameWindows in the interior type of templates
