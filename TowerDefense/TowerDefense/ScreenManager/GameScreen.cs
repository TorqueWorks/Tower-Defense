...
namespace TowerDefense
{
    ...
    public abstract class GameScreen
    {
        ...
        /// </summary>
        public virtual void Update(GameTime aGameTime, bool aOtherScreenHasFocus,
                                                      bool aCoveredByOtherScreen)
        {
            this.otherScreenHasFocus = aOtherScreenHasFocus;
            ...
            if (IsExiting)
            {
                ...
                if (!UpdateTransition(aGameTime, transitionOffTime, 1))
                {
                    // When the transition finishes, remove the screen.
                    ScreenManager.RemoveScreen(this);
                }
            }
            else if (aCoveredByOtherScreen)
            {
            ...
            else
            {
                ...
                if (UpdateTransition(aGameTime, transitionOnTime, -1))
                {
                    // Still busy transitioning.
                    screenState = ScreenState.TransitionOn;
                }
